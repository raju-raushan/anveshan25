...
const events: Event[] = [
  ...
  { id: 11, title: 'LAN Gaming', category: 'Techno Parv', description: 'Compete in adrenaline-pumping multiplayer games for the ultimate gaming glory.', icon: Code, date: 'November 1, 2025', time: '9:00 AM', participants: '500+', image: 'appareal-show-poster.jpg', registrationFee: '₹200', facultyCoordinator: [{ name: 'Prof. Dilip Solanki', phone: '98267 18678' }], studentCoordinator: [{ name: 'Om Shukla', phone: '8989468730' },{ name: 'Aditya Verma', phone: '78188 39571' }], registrationLink: 'https://sageuniversity.in/sage_events/anveshan/' },
  // { id: 12, title: 'Capture the Flag', category: 'Techno Parv', description: 'Solve cybersecurity challenges to uncover hidden “flags” and prove your hacking skills.', icon: Brain, date: 'November 1, 2025', time: '10:00 AM', participants: '200+', image: 'battle-of-bands-poster.jpg', registrationFee: '₹100', facultyCoordinator: [{ name: 'Mr. Ravikant kori', phone: '91096 19488' }], studentCoordinator: [{ name: 'Tushar Kaushik', phone: '8602198299' }], registrationLink: 'https://sageuniversity.in/sage_events/anveshan/' },
  ...
  { id: 15, title: 'Treasure Hunt', category: 'Cultural Carnival', description: 'Solve clues, race against time, and uncover the hidden treasure with your team.', icon: Lightbulb, date: '31/10/2025', time: '11:00 AM', participants: '100+', image: 'treasure-hunt-poster.jpg', registrationFee: '₹600', facultyCoordinator: [{ name: 'Prof. Siddharth Nath', phone: '89895 25943' }], studentCoordinator: [{ name: 'Lakshya Kher', phone: '8770214586' },{ name: 'Aryan Dev', phone: '7251901448' }], registrationLink: 'https://sageuniversity.in/sage_events/anveshan/' },
  ...
  { id: 17, title: 'DANCE', category: 'Cultural Carnival', description: 'Express your rhythm, energy, and emotions through electrifying dance moves.', icon: Smartphone, date: '31/10/2025', time: '01:30 - 03:00 PM', participants: '250+', image: 'short-movie-poster.jpg', registrationFee: 'Solo - ₹400 | Group - ₹1000', facultyCoordinator: [{ name: 'Prof. Shaziya Sheikh', phone: '79743 23413' }], studentCoordinator: [{ name: 'Yogeshwari Agrawal ', phone: '80851 84206' },{ name: 'Disha Bais', phone: '96303 34125' }], registrationLink: 'https://sageuniversity.in/sage_events/anveshan/' },
  { id: 18, title: 'Singing', category: 'Cultural Carnival', description: 'Let your voice steal the spotlight and mesmerize the audience with your melody.', icon: Lightbulb, date: '30/10/2025', time: '01:00 - 2:00 PM', participants: '100+', image: 'dancing-poster.jpg', registrationFee: '₹300', facultyCoordinator: [{ name: 'Prof. Varsha Patil', phone: '85528 14965' }], studentCoordinator: [{ name: 'N/A', phone: 'N/A' }], registrationLink: 'https://sageuniversity.in/sage_events/anveshan/' },
  ...
  { id: 20, title: 'Gully Cricket', category: 'Sports', description: 'Relive the street cricket thrill with fun, passion, and quick reflexes.', icon: Lightbulb, date: '29/10/2025', time: '3:00 PM', participants: '100+', image: 'chess-poster.jpg', registrationFee: '₹600', facultyCoordinator: [{ name: 'Prof Lakhmichand Deshmukh', phone: 'N/A' }], studentCoordinator: [{ name: 'PUNJ PRAKASH', phone: '8235694421' },{ name: 'SUMIT YADAV', phone: '8720024344' }], registrationLink: 'https://sageuniversity.in/sage_events/anveshan/' },
  ...
  { id: 23, title: 'Badminton (Single)', category: 'Sports', description: 'Test your agility and precision in an intense one-on-one shuttle battle.', icon: Lightbulb, date: '29/10/2025', time: '3:00 PM', participants: '100+', image: 'gully-cricket-poster.jpg', registrationFee: 'Under 18 - ₹200 | Above 18 - ₹250', facultyCoordinator: [{ name: 'Dr. Deepak K Yadav', phone: 'N/A' }], studentCoordinator: [{ name: 'KHUSHAL KANATHEY', phone: '9399199027' },{ name: 'YATHARTH PATEL', phone: '9238803405' }], registrationLink: 'https://sageuniversity.in/sage_events/anveshan/' },
  { id: 24, title: 'Badminton (Double)', category: 'Sports', description: 'Team up and coordinate for fast-paced rallies and smashing victories.', icon: Lightbulb, date: '29/10/2025', time: '3:00 PM', participants: '100+', image: 'cricket-poster.jpg', registrationFee: 'Under 18 - ₹350 | Above 18 - ₹400', facultyCoordinator: [{ name: 'Prof Jeetesh K Jain', phone: 'N/A' }], studentCoordinator: [{ name: 'MAYANK DEWANGAN', phone: '9827950327' },{ name: 'MAYANK DEWANGAN', phone: '9827950327' }], registrationLink: 'https://sageuniversity.in/sage_events/anveshan/' },
  { id: 25, title: 'Basket Ball', category: 'Sports', description: 'Dunk, shoot, and defend in a thrilling match of teamwork and stamina.', icon: Lightbulb, date: '29/10/2025', time: '3:00 PM', participants: '100+', image: 'football-poster.jpg', registrationFee: '₹1100', facultyCoordinator: [{ name: 'Dr. Deepak K Yadav', phone: 'N/A' }], studentCoordinator: [{ name: 'MALAY PATEL', phone: '7489529344' },{ name: 'KRISHNA RAJHANS', phone: '6266302604' }], registrationLink: 'https://sageuniversity.in/sage_events/anveshan/' },
  { id: 26, title: 'Chess', category: 'Sports', description: 'Outsmart your opponent in this ultimate game of strategy and intellect.', icon: Lightbulb, date: '29/10/2025', time: '3:00 PM', participants: '100+', image: 'volleyball-poster.jpg', registrationFee: '₹200', facultyCoordinator: [{ name: 'Prof. Lokendra Vishvakarma', phone: 'N/A' }], studentCoordinator: [{ name: 'ROHIT MISHRA', phone: '91791090006' }], registrationLink: 'https://sageuniversity.in/sage_events/anveshan/' },
  { id: 27, title: 'Volley Ball', category: 'Sports', description: 'Set, spike, and serve your way through exciting rallies on the court.', icon: Lightbulb, date: '29/10/2025', time: '3:00 PM', participants: '100+', image: 'basketball-poster.jpg', registrationFee: '₹1000', facultyCoordinator: [{ name: 'Prof Kunal Batra', phone: 'N/A' }], studentCoordinator: [{ name: 'VEDANT PATEL', phone: '9589396704' },{ name: 'VISHWAJEET RATHORE', phone: '7415674055' }], registrationLink: 'https://sageuniversity.in/sage_events/anveshan/' },
  ...
  { id: 34, title: 'Table Tennis', category: 'Sports', description: 'Smash and spin your way through fast-paced rallies for the win.', icon: Lightbulb, date: '29/10/2025', time: '3:00 PM', participants: '100+', image: 'table-tennis-poster.jpg', registrationFee: '₹150', facultyCoordinator: [{ name: ' Prof. Vinod Azad', phone: 'N/A' }], studentCoordinator: [{ name: 'SANYOG', phone: '8839574422' },{ name: 'BHAVESH', phone: '6263142567' }], registrationLink: 'https://sageuniversity.in/sage_events/anveshan/' },
